...
- Paste the preceding code into a Windows Form, and call the `ExtractAssociatedIconEx` method from the form's constructor or <xref:System.Windows.Forms.Form.Load> event-handling method.  
